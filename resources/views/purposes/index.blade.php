...
<div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow lg:col-span-1">
        <h2 class="text-xl font-bold mb-6 text-black">New Purpose</h2>

        <form id="purposeForm" class="space-y-4">
            @csrf

            <div>
                <label class="block text-sm font-medium text-black">Purpose Name</label>
    ...
    <div class="bg-white p-6 rounded-lg shadow lg:col-span-2">
        ...
        <div class="flex justify-between mb-4">
            <h2 class="text-xl font-bold text-black">Purpose List</h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full border" id="purposeTable">

                <thead class="bg-gray-100">
                    <tr>
                        <th class="p-3 border text-left">Purpose Name</th>
                ...
                @foreach($purposes as $purpose)
                    ...
                    <tr id="row-{{ $purpose->id }}">
                        ...
                        <td class="p-3 border purposeName">
                            {{ $purpose->name }}
                        </td>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center">
    ...
    <div class="bg-white p-6 rounded shadow w-96">
        ...
        <h3 class="text-lg font-bold mb-4">Edit Purpose</h3>

        <input type="hidden" id="editId">

        <div class="mb-4">
            <label class="block text-sm">Purpose Name</label>
...
$("#purposeTable tbody tr").filter(function(){
